  ...
  <fu-popup v-model="isShow" mode="center" border-radius="16" :mask-close-able="false">
    <view class="update-box">
      ...
      <view class="foot solid-top">
        <view class="flex-sub text-gray solid-right" @click="handleCancel">{{i18n['下次再说']}}</view>
        <view class="flex-sub text-green" @click="handleConfirm">{{i18n['马上更新']}}</view>
      </view>
    </view>
  </fu-popup>
</template>
                    ...
                    success: (downloadResult) => {
                      if (downloadResult.statusCode === 200) {
                        ...
                        self.$util.showModal({
                          ...
                          content: global.i18n['已准备好新版本,是否重启体验新版?'],
